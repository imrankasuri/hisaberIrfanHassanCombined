  ...
  const handleFile = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${Config.base_url}CustomerSupplier/UploadSupplierExcel/${CompanyID}`, // Use template literal for better readability
        formData,
        {
          headers: {
              ...
              <Row align="middle">
                <Col md={10} xs={24}>
                  <div className="left-form-tittle">
                    <h2>Import CSV List of Suppliers</h2>
                    ...
                    <NavLink
                      to={`https://new.hisaaber.com/SampleSheets/SupplierList_Import_Sample.xlsx`}
                      target="_blank"
                    >
