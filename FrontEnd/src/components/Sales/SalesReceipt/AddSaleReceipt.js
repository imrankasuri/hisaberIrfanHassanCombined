...
const AddSalesReceipt = () => {
  ...
  useEffect(() => {
    document.title = "Add Sale Receipt";
  ...
  const handleCustomerChange = async (value) => {
    ...
    const apiUrl = `${Config.base_url}Sales/GetByBalance/${CompanyID}?customerCode=${customer.accountCode}&saleType=Invoice`;
...
export default AddSalesReceipt;
