...
const AddReturnReceipt = () => {
  ...
  useEffect(() => {
    document.title = "Add Sale Return Receipt";
  ...
  const handleCustomerChange = async (value) => {
    ...
    const apiUrl = `${Config.base_url}ReceiptHead/GetReceiptBy/${CompanyID}?customerCode=${customer.accountCode}&receiptType=Receipt`;
...
export default AddReturnReceipt;
