  ...
  const handleFile = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${Config.base_url}Product/UploadExcel/${CompanyID}`, // Use template literal for better readability
        formData,
        {
          headers: {
              ...
              <Row align="middle">
                <Col md={10} xs={24}>
                  <div className="left-form-tittle">
                    <h2>Import CSV List of Stock Adjustment</h2>
                    ...
                    <NavLink
                      to={`https://new.hisaaber.com/SampleSheets/ProductList_Import_Sample.xlsx`}
                      target="_blank"
                    >
