...
function EditNonStockProducts(props) {
  ...
  useEffect(() => {
    document.title = "Edit Non Stock Products";
    GetProductData();
...
export default EditNonStockProducts;
