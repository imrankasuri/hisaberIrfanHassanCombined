  ...
  const handleFile = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${Config.base_url}CustomerSupplier/UploadCustomerExcel/${CompanyID}`,
        formData,
        {
          headers: {
              ...
              <Row align="middle">
                <Col md={10} xs={24}>
                  <div className="left-form-tittle">
                    <h2>Import CSV List of Customers</h2>
                    ...
                    <NavLink
                      to={`https://new.hisaaber.com/SampleSheets/CustomerList_Import_Sample.xlsx`}
                      target="_blank"
                    >
