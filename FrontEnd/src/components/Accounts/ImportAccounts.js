  ...
  const handleFile = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${Config.base_url}AccountMain/UploadExcel/${CompanyID}?Year=${FYear}`, // Use template literal for better readability
        formData,
        {
          headers: {
              ...
              <Row align="middle">
                <Col md={10} xs={24}>
                  <div className="left-form-tittle">
                    <h2>Import CSV List of Accounts</h2>
                    ...
                    <NavLink
                      to={`https://new.hisaaber.com/SheetSamples/AccountList_Import_Sample.xlsx`}
                      target="_blank"
                    >
