...
const AddSupplierPayment = () => {
  ...
  useEffect(() => {
    document.title = "Add Supplier Payment";
  ...
  const handleSupplierChange = async (value) => {
    ...
    const apiUrl = `${Config.base_url}PurchaseHead/GetByBalance/${CompanyID}?supplierCode=${supplier.accountCode}&purchaseType=Bill`;
