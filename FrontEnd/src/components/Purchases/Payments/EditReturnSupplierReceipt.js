...
const EditReturnSupplierReceipt = () => {
  ...
  useEffect(() => {
    document.title = "Edit Supplier Return Receipt";
    fetchSupplierData();
    fetchBankAccounts();
    fetchBankMode();
    PaymentBodyData();
...
export default EditReturnSupplierReceipt;
