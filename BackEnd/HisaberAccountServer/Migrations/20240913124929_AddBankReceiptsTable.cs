...
{
    /// <inheritdoc />
    public partial class AddBankReceiptsTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblBankReceipts",
                columns: table => new
                {
                    ...
                    NominalAccount = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    BankReceiptType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    BankReceiptBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    VoucherNo = table.Column<long>(type: "bigint", nullable: false),
                    CompanyID = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    BankReceipt = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblBankReceipts", x => x.ID);
                });
        }
