...
{
    /// <inheritdoc />
    public partial class AddGetOpeningBalanceProcedure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
            CREATE PROCEDURE GetOpeningBalance
    @startDate DATE,
    @CompanyID INT,
...
");
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS GetOpeningBalance");
        }
    }
