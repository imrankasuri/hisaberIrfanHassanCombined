...
{
    /// <inheritdoc />
    public partial class AddBankPaymentsTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblBankPayments",
                columns: table => new
                {
                    ...
                    BankPaymentType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    BankPaymentBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblBankPayments", x => x.ID);
                });
        }
